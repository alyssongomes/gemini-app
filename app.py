...
# anexar um manipulador do Cloud Logging ao logger raiz
log_client = cloud_logging.Client()
log_client.setup_logging()

PROJECT_ID = os.environ.get('PROJECT_ID')   # O ID do Google Cloud do seu projeto do Qwiklabs
LOCATION = os.environ.get('REGION')         # A região do seu projeto do Google Cloud do Qwiklabs 
